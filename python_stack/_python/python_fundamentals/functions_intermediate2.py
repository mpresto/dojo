...
"""Create a function iterate_dictionary(some_list) that, given a list of
...
a list of dictionaries and a key name, the function prints the value stored
in that key for each dictionary. For example,
